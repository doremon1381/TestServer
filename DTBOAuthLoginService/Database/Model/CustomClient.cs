...
{
    /// <summary>
    /// Copy from Duende.IdentityServer.Models
    /// </summary>
    [PrimaryKey(nameof(ID))]
    public class CustomClient : IDbTable
    {
        ...
        private List<string> _allowedGrantTypes = new List<string>();
        ...
        /// </summary>
        public List<Model.Secret> ClientSecrets { get; set; } = new List<Model.Secret>();
        ...
        /// The claims.
        /// </value>
        public List<Model.ClientClaim> Claims { get; set; } = new List<Model.ClientClaim>();
